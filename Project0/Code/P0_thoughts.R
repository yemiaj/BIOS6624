...
#Critique
1)A detailed/accurate quadratic or polynomial pattern may not be sussed out from just 4 sample collection timepoints.
...
3)Bland and Altman plot for agreement [Q1], paired T-test for adherence to 30min & 10hr [Q2], 
